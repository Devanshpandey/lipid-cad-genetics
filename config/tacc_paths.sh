...
# --- Project directories ---
TACC_WORK="/path/to/cad-genetics"
TACC_SCRATCH="/path/to/scratch/cad-genetics"
...
BCFTOOLS="/path/to/software/bcftools/bcftools"

# LDSC scripts
LDSC_PY="/path/to/software/ldsc/ldsc.py"
MUNGE_PY="/path/to/software/ldsc/munge_sumstats.py"

# ---------------------------------------------------------------
# UKB GENOTYPE DATA  (corral — read-only)
# ---------------------------------------------------------------
UKB_GENO_ROOT="/path/to/ukb_genotypes"
...
# Confirmed path: /path/to/ukb_wes/
...
# ---------------------------------------------------------------
UKB_PHENO_DIR="/path/to/ukb_phenotypes"
...
# ---------------------------------------------------------------
LDSC_REF_DIR="/path/to/software/ldsc/data/ldsc_references"
